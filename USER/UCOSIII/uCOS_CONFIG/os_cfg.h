...
#define OS_CFG_H
                                             ...
                                             /* ---------------------------- MISCELLANEOUS -------------------------- */
#define OS_CFG_APP_HOOKS_EN             0u   /* Enable (1) or Disable (0) application specific hooks  如果根本不打算扩充μC/OS-III钩子函数功能，则将该宏设置为0，来节省内存(例如，函数指针的开销)。                */
...
#define OS_CFG_DBG_EN                   0u   /* Enable (1) debug code/variables OS_CFG_DBG_EN                                      */
#define OS_CFG_ISR_POST_DEFERRED_EN     0u   /* Enable (1) or Disable (0) Deferred ISR posts   中断延时发布                       */
...
#define OS_CFG_PEND_MULTI_EN            0u   /* Enable (1) or Disable (0) code generation for multi-pend feature 使能“等待多个内核对象”     */
...
#define OS_CFG_SCHED_ROUND_ROBIN_EN     0u   /* Include code for Round-Robin scheduling 是否生成时间片轮转调度代码                              */
#define OS_CFG_STK_SIZE_MIN            64u   /* Minimum allowable task stack size                                     */


                                             /* ----------------------------- EVENT FLAGS --------------------------- */
#define OS_CFG_FLAG_EN                  1u   /* Enable (1) or Disable (0) code generation for EVENT FLAGS             */
#define OS_CFG_FLAG_DEL_EN              0u   /*     Include code for OSFlagDel()     删除事件标志组                                 */
...
#define OS_CFG_SEM_SET_EN               1u   /*    Include code for OSSemSet()                                        */
                                             ...
                                             /* -------------------------- TASK MANAGEMENT -------------------------- */
#define OS_CFG_STAT_TASK_EN             1u   /* Enable (1) or Disable(0) the statistics task   使能统计任务                       */
