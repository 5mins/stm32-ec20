...
uint8_t Rx_Buffer[sFlash_BufferSize];
...
void sFLASH_Init(void)
{
  ...
  SPI_InitStructure.SPI_BaudRatePrescaler = SPI_BaudRatePrescaler_4;//·ÖÆµÉèÖÃ
...
void sFLASH_LowLevel_Init(void)
{
  ...
  GPIO_InitStructure.GPIO_PuPd  = GPIO_PuPd_DOWN;//debug
